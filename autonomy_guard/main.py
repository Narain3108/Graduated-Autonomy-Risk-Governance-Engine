...
def _register_routes(app: FastAPI) -> None:
    ...
    from autonomy_guard.api.v1.approvals import router as approvals_router
    from autonomy_guard.api.v1.audit import router as audit_router
    from autonomy_guard.api.v1.evaluate import router as evaluate_router
